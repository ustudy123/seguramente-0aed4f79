...
BEGIN
  ...
  -- Inclui desligados e cadastros inativados: a resposta foi dada enquanto a
  -- pessoa estava na empresa, e ignorá-la jogava a resposta em "Sem GHE".
  -- Cadastro ativo tem preferência quando há mais de um para o mesmo CPF.
  adm AS (
    SELECT
      cm.campanha_id,
      encode(
