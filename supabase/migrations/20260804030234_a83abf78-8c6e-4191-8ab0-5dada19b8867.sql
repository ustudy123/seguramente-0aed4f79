...
DECLARE
  ...
  v_qtd_sab int := 0;
  v_ult_sab date;           -- RN05: último sábado da competência
  v_exc_decidido boolean;
  r RECORD;
BEGIN
  -- Último sábado do mês: o débito de fechamento pertence juridicamente ao dia
  -- de equalização (sábado), nunca ao último dia corrido da competência.
  ...
  -- Fallback: sem sábado trabalhado, o débito de fechamento cai no ÚLTIMO
  -- SÁBADO da competência (dia de equalização), não no último dia do mês.
