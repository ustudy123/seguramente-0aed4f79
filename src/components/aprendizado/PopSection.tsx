...
export function PopSection({ atividade, cargoId, funcaoNome, nivel, ferramentas, interfaces }: PopSectionProps) {
  const { getPopByAtividade, criarPop, criandoPop, atualizarPop, atualizandoPop, excluirPop, gerarPopIA, reescreverTrechoIA, buscarVersoes } = usePopAtividade(cargoId);
