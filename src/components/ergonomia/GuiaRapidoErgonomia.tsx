...
const PASSOS = [
  ...
  },
  {
    ...
    subtitulo: "Por onde começar: a Análise Ergonômica Preliminar",
    descricao:
      "A AEP é o ponto de entrada do sistema. Ela documenta as condições de trabalho de cada função e alimenta automaticamente o Inventário GRO com os riscos identificados. Comece sempre por aqui.",
    acoes: [
      "Clique na aba **1. Avaliar Riscos (AEP)**",
      "Escolha **Função Única** (uma função por vez) ou **Multi-Setor** (várias funções de uma só vez)",
      "Selecione o setor e a função a ser avaliada",
      "O sistema preenche automaticamente CNPJ e razão social da empresa",
      "Preencha as condições do posto de trabalho e clique em **Gerar AEP**",
      "O documento é gerado em PDF e os riscos identificados vão direto para o Inventário GRO",
    ],
    dica: "Use o modo Multi-Setor para avaliar várias funções de uma vez e ganhar tempo. Quanto mais AEPs geradas, mais completo ficará o inventário de riscos da empresa.",
  },
  {
    id: "inventario",
    icon: ShieldCheck,
