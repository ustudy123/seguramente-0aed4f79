...
const FLUXO_LINHAS: { etapa: string; sistema: string; cor: RGB }[] = [
  { etapa: "Criar AEP por Situacao",   sistema: "Par Setor + Funcao (NR-17) | Trabalho real vs. prescrito | Metadados automaticos da empresa",     cor: VERDE },
  { etapa: "Preencher AEP (sec.17.5)", sistema: "Ruido <= 65 dB(A) | Temperatura 20-23 C | Umidade >= 40% | Velocidade ar <= 0,75 m/s",            cor: VERDE },
  { etapa: "Preencher AEP (sec.17.6)", sistema: "Cotas/metas | Pausas (10 min/50 min para dados) | Jornada | Autonomia | Indicadores de saude",    cor: VERDE },
  { etapa: "Checklist NR-17",          sistema: "12 itens auditaveis (sec.17.2 a 17.6) | % conformidade automatico | Alerta abaixo de 80%",        cor: AMBER },
  { etapa: "Sintese e AET",            sistema: "Classificacao geral do risco | Pontos criticos | Motor AET detecta gatilhos automaticamente",      cor: VERMELHO },
  ...
  { etapa: "Risco Alto ou Critico",    sistema: "Plano de Acao 5W2H vinculado | Prazo: 30d (Critico) | 60d (Alto) | Bloqueio sem acao vinculada",  cor: VERMELHO },
  { etapa: "Gerar Documentos",         sistema: "Metodologia (RQ-26) + Comunicacao Trabalhadores (RQ-19/20) exportados em PDF",                    cor: VERDE },
  { etapa: "Monitorar Score GRO",      sistema: "Score 0-100% de maturidade | Checklist conformidade NR-01 | Auxilia preparacao para auditorias",  cor: AZUL },
...
const GLOSSARIO: [string, string][] = [
  ...
  ["AEP",             "Analise Ergonomica Preliminar. Abordagem inicial focada na Funcao/Posto de trabalho para mapear condicoes reais, antes de estudos aprofundados (AET)."],
  ["AET",             "Analise Ergonomica do Trabalho. Estudo tecnico detalhado exigido pela NR-17 quando a AEP nao resolve o problema, ha LER/DORT ou risco critico identificado."],
  ["GHE",             "Grupo de Exposicao Homogenea. Trabalhadores da NR-1 que executam a mesma funcao no mesmo ambiente e podem ser analisados em conjunto na AEP."],
  ["Sit. Trabalho",   "Unidade de analise ergonomica — par Setor + Funcao que representa uma realidade de trabalho distinta. E o nivel exigido pela NR-17 para a AEP."],
  ["Checklist NR-17", "Lista de 12 itens baseada no Manual de Aplicacao da NR-17 (MTE, 2002) que auditores fiscais verificam obrigatoriamente. O sistema calcula % de conformidade."],
  ...
  ["NR-17",           "Norma Regulamentadora 17 — parametros para adaptacao das condicoes de trabalho ao trabalhador: mobiliario, equipamentos, condicoes ambientais (sec.17.5) e organizacao do trabalho (sec.17.6)."],
  ...
  ["LER/DORT",        "Lesoes por Esforco Repetitivo / Doencas Osteomusculares Relacionadas ao Trabalho. Indicadores de saude monitorados na AEP como evidencia de sobrecarga ergonomica."],
