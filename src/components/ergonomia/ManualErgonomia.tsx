...
const PASSOS = [
  {
    ...
    cor: VERDE,
    paragrafos: [
      'O modulo de Ergonomia Inteligente do Seguramente centraliza toda a gestao de riscos ergonomicos da sua empresa. Ele foi desenvolvido para atender as exigencias legais da NR-17 (Ergonomia), NR-01 (Gestao de Riscos Ocupacionais) e ISO 45001/45003, reunindo em um so lugar tudo que voce precisa: identificacao de riscos, analise tecnica, planos de acao e documentos de conformidade.',
      'Voce nao precisa ser especialista em ergonomia para usar este modulo. O sistema orienta cada etapa com linguagem simples, automatiza os calculos de criticidade e gera os documentos obrigatorios com um clique. O objetivo e que o RH, o gestor ou o tecnico de SST consiga gerenciar os riscos ergonomicos de forma organizada e documentada.',
      'A estrutura do modulo segue o ciclo GRO (Gerenciamento de Riscos Ocupacionais) em 5 etapas: Avaliar Riscos (AEP), Inventario GRO, Riscos Prioritarios, Plano de Acao e Monitoramento. Cada etapa tem uma funcao clara e se integra com as demais.',
    ],
    dica: "Dica: Comece sempre pela AEP (Analise Ergonomica Preliminar). Ela e a porta de entrada que alimenta todo o sistema com as informacoes necessarias para as etapas seguintes.",
  },
  {
    num: "02",
    titulo: "Passo 1 — Analise Ergonomica Preliminar (AEP)",
    subtitulo: "A porta de entrada obrigatoria do GRO",
    cor: VERDE,
    paragrafos: [
      'A AEP (Analise Ergonomica Preliminar) e o primeiro documento tecnico obrigatorio antes de qualquer avaliacao de risco mais aprofundada. Ela mapeia as condicoes de trabalho por "Situacao de Trabalho" - que e sempre um par de Setor + Funcao.',
      ...
      'A AEP inclui obrigatoriamente 6 dominios conforme a NR-17 e a ISO 45003: (1) Ritmo e Carga de Trabalho, (2) Demandas Cognitivas e Emocionais, (3) Autonomia e Controle, (4) Relacoes e Suporte, (5) Suporte Organizacional e (6) Clareza de Papel. Se a empresa ja realizou campanhas psicossociais, esses dados sao preenchidos automaticamente como evidencia objetiva.',
    ],
    dica: "Atencao: A AEP nao e um documento opcional. A NR-17 exige que toda empresa avalie as condicoes ergonomicas dos postos de trabalho antes de implementar qualquer mudanca. A AEP e o ponto de partida documental desta exigencia.",
  },
  {
    num: "03",
    ...
    paragrafos: [
      ...
      'Os niveis de risco sao classificados em: Baixo (1-4) - apenas monitorar; Moderado (5-9) - acoes preventivas; Alto (10-15) - intervencao prioritaria com prazo de 60 dias; Critico (16-25) - intervencao imediata com prazo de 30 dias e bloqueio de encerramento sem acao vinculada.',
    ],
    dica: "Importante: Riscos classificados como Alto ou Critico nao podem ser encerrados ou arquivados sem ter um Plano de Acao 5W2H formalmente vinculado. Isso garante que nenhum risco grave fique sem tratamento documentado.",
  },
  {
    num: "04",
    ...
    cor: AMBER,
    paragrafos: [
      'O Motor AET e o cerebro analitico do sistema. Com base nos riscos registrados no Inventario GRO e nos dados psicossociais das campanhas, ele gera automaticamente uma lista de analises tecnicas recomendadas, classificadas em tres niveis: Obrigatorias (risco alto/critico), Recomendadas (risco moderado com indicios adicionais) e Sugeridas (boas praticas preventivas).',
      'Acesse a aba "Motor AET" para visualizar as recomendacoes. Analises marcadas como Obrigatorias devem ser priorizadas imediatamente e precisam ser concluidas dentro do prazo estabelecido pelo nivel de risco. Cada recomendacao explica o fundamento legal (qual NR ou norma justifica a analise) e o que deve ser feito.',
      'O Motor AET tambem monitora o IPS (Indice Psicossocial) do modulo de Avaliacao. Quando o IPS fica abaixo de 65%, o sistema indica automaticamente a necessidade de Analise Ergopsicossocial - que combina dados ergonomicos com fatores de saude mental e organizacao do trabalho, conforme exige a ISO 45003.',
    ],
    dica: "Dica: Marque as analises como Concluidas apos executa-las. Isso atualiza o Score de Maturidade GRO - um indicador que mostra o grau de conformidade da empresa com as obrigacoes ergonomicas.",
  },
  {
    num: "05",
    ...
    paragrafos: [
      ...
      'Esta funcionalidade e especialmente util para analises rapidas de novos postos de trabalho, avaliacao de reclamacoes especificas de colaboradores ou para fundamentar laudos tecnicos com mais agilidade. Nao substitui a AEP formal, mas e um excelente ponto de partida.',
    ],
  ...
  },
  {
    ...
    paragrafos: [
      ...
      'Riscos criticos geram automaticamente uma proposta de acao com prazo de 30 dias. Riscos altos geram proposta com prazo de 60 dias. Voce pode aceitar a proposta automatica ou editar conforme a realidade da empresa. Defina um responsavel nominal para cada acao - isso cria responsabilidade clara e facilita o acompanhamento.',
      'O progresso de cada acao pode ser atualizado em tempo real (0% a 100%). Acoes concluidas devem ter evidencias anexadas (fotos, laudos, notas fiscais de compra de equipamentos). O sistema monitora os prazos e envia alertas para acoes proximas do vencimento ou atrasadas.',
    ],
  ...
  },
  {
    ...
    paragrafos: [
      ...
      'O Score de Maturidade GRO e um indicador de 0 a 100% que responde automaticamente as perguntas obrigatorias de auditoria da NR-01. Ele avalia: se a empresa tem inventario atualizado, se riscos altos/criticos tem acoes vinculadas, se as acoes estao dentro do prazo, se ha reavaliacao periodica e se os documentos de comunicacao aos trabalhadores estao gerados.',
      'Para aumentar o Score de Maturidade, siga a ordem: 1) Cadastre todos os riscos no GRO; 2) Vincule acoes a todos os riscos altos/criticos; 3) Mantenha as acoes dentro do prazo; 4) Gere os documentos de comunicacao; 5) Realize reavaliacao anual dos riscos. Um score acima de 70% indica conformidade basica com a NR-01.',
    ],
    dica: "Para auditorias: O Score de Maturidade GRO e o principal indicador que um auditor de SST vai analisar. Mantenha-o acima de 70% para demonstrar conformidade continua. Riscos com acao atrasada reduzem significativamente o score.",
  },
  {
    num: "08",
    titulo: "Documentos Obrigatorios — Metodologia e Comunicacao",
    subtitulo: "Os documentos que a lei exige e o sistema gera automaticamente",
    cor: VERDE,
    paragrafos: [
      'O modulo gera dois documentos tecnicos obrigatorios: (1) Documento de Metodologia (RQ-26) — descreve os criterios de avaliacao de risco utilizados (Probabilidade x Severidade), a fundamentacao legal do programa ergonomico e o uso de inteligencia artificial na analise. Este documento e exigido pela NR-01 como evidencia de que a empresa possui metodologia formal de gestao de riscos.',
      '(2) Relatorio de Comunicacao aos Trabalhadores (RQ-19/20) — informa aos colaboradores sobre os riscos identificados em seus postos de trabalho e as medidas de controle adotadas. A NR-01 obriga as empresas a comunicar os resultados da gestao de riscos aos trabalhadores. Este documento deve ser distribuido ou fixado em murais e pode ser comprovado em auditorias.',
    ...
    dica: "Conformidade: Guarde os documentos gerados por pelo menos 5 anos. Em caso de acidente de trabalho ou acao trabalhista, esses documentos demonstram que a empresa cumpriu suas obrigacoes legais e tomou medidas preventivas. O sistema arquiva automaticamente, mas mantenha copias fisicas se necessario.",
  },
  {
    num: "09",
    ...
    cor: ROXO,
    paragrafos: [
      'O modulo de Ergonomia nao funciona de forma isolada. Ele se integra nativamente com outros modulos da plataforma para fornecer uma visao completa da saude ocupacional: (1) Psicossocial — os dados das campanhas psicossociais (IPS e fatores de risco) alimentam automaticamente a AEP e o Motor AET. Quando o IPS e baixo, o sistema cruza com os riscos ergonomicos para identificar sobrecargas combinadas.',
      '(2) Saude / Atestados — afastamentos por LER/DORT (lesoes por esforco repetitivo) sao cruzados com os postos de trabalho registrados no GRO. Quando a taxa de afastamentos por uma doenca ergonomica supera o esperado, o sistema gera um alerta de "Contraprova Organizacional" que corrobora os riscos identificados na avaliacao. (3) Plano de Acao Global — todas as acoes criadas no modulo de ergonomia aparecem no Plano de Acao Global da empresa, onde qualquer gestor pode acompanhar o progresso.',
    ...
    dica: "Visao integrada: Uma empresa que usa o modulo de Ergonomia em conjunto com Psicossocial e Saude tem uma gestao muito mais robusta. Os tres modulos se complementam: o psicossocial identifica o estresse percebido, a ergonomia identifica os fatores fisicos/organizacionais que causam esse estresse, e o modulo de saude confirma os impactos atraves dos indicadores de absenteismo e doencas.",
  },
];

// Fluxo resumido
const FLUXO_LINHAS: { etapa: string; sistema: string; cor: RGB }[] = [
  { etapa: "Criar AEP",                sistema: "Preencher Setor+Funcao | 6 dominios NR-17 | Metadados da empresa",                              cor: VERDE },
  { etapa: "Cadastrar Riscos no GRO",  sistema: "Probabilidade x Severidade = Nivel de Risco (1-25) | Classificacao automatica",                  cor: AZUL },
  { etapa: "Motor AET analisa",        sistema: "Gera lista de analises Obrigatorias, Recomendadas e Sugeridas | Integra dados psicossociais",     cor: AMBER },
  { etapa: "Risco Alto ou Critico",    sistema: "Plano de Acao 5W2H obrigatorio | 30d (Critico) | 60d (Alto) | Bloqueio sem acao",                cor: VERMELHO },
  ...
  { etapa: "Monitorar Score GRO",      sistema: "Score 0-100% de conformidade | Responde perguntas de auditoria NR-01 automaticamente",           cor: AZUL },
...
const GLOSSARIO: [string, string][] = [
  ["GRO",           "Gerenciamento de Riscos Ocupacionais. Inventario obrigatorio de todos os riscos identificados na empresa, exigido pela NR-01."],
  ["PGR",           "Programa de Gerenciamento de Riscos. Documento obrigatorio que inclui o inventario GRO e os planos de acao."],
  ["AEP",           "Analise Ergonomica Preliminar. Documento inicial que mapeia as condicoes de trabalho por funcao, antes de uma analise mais aprofundada."],
  ["AET",           "Analise Ergonomica do Trabalho. Estudo tecnico detalhado de uma situacao de trabalho especifica, exigido pela NR-17 em situacoes criticas."],
  ["NR-01",         "Norma Regulamentadora 1 — obriga empresas a identificar, avaliar e controlar riscos ocupacionais e manter o PGR atualizado."],
  ["NR-17",         "Norma Regulamentadora 17 — regula a ergonomia no trabalho, incluindo mobiliario, equipamentos, condicoes ambientais e organizacao do trabalho."],
  ["ISO 45001",     "Norma internacional de sistema de gestao de saude e seguranca ocupacional."],
  ["ISO 45003",     "Norma internacional especifica para gestao de riscos psicossociais no trabalho, complementar a NR-01."],
  ["P x S",         "Probabilidade x Severidade. Calculo que determina o nivel de risco: probabilidade de ocorrencia (1-5) multiplicada pela severidade do dano (1-5)."],
  ["Score GRO",     "Indicador de 0-100% que mede o grau de conformidade do programa ergonomico com as exigencias da NR-01."],
  ["LER/DORT",      "Lesoes por Esforco Repetitivo / Doencas Osteomusculares Relacionadas ao Trabalho. Doen,as causadas por movimentos repetitivos, postura inadequada ou sobrecarga fisica."],
  ["5W2H",          "Modelo de plano de acao: O que, Por que, Onde, Quando, Quem, Como e Quanto custa."],
  ["Sit. Trabalho", "Par de Setor + Funcao que representa um grupo homogeneo de trabalhadores com mesmas condicoes de trabalho."],
  ["RQ-26",         "Documento de Metodologia Ergonomica — descreve os criterios tecnicos e legais do programa ergonomico da empresa."],
  ["RQ-19/20",      "Relatorio de Comunicacao aos Trabalhadores — informa colaboradores sobre riscos e medidas de controle adotadas."],
];
