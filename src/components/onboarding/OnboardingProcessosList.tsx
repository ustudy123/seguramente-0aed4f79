...
import { PROCESSO_STATUS_LABELS } from "@/types/onboarding";
  ...
  if (processos.length === 0) {
    return (
      <div className="text-center py-16 bg-card rounded-xl border border-border">
        <User className="w-12 h-12 text-muted-foreground/30 mx-auto mb-4" strokeWidth={1.5} />
        <h3 className="text-lg font-semibold text-foreground mb-2">Nenhum onboarding ativo</h3>
        <p className="text-sm text-muted-foreground max-w-md mx-auto">
          Quando novos colaboradores forem admitidos e houver templates configurados, os processos de onboarding aparecerão aqui automaticamente.
        </p>
      </div>
    );
  }
