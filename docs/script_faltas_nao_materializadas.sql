-- ============================================================
-- Faltas nao materializadas — 04/08/2026
-- Cria a rotina diaria e as funcoes de diagnostico/recuperacao.
-- NAO materializa o passado sozinho: veja o rodape.
-- ============================================================
...
-- ============================================================
-- ANTES de recuperar o passado, veja o tamanho do buraco:
--   SELECT * FROM public.ponto_dias_nao_materializados('<tenant>','2026-07');
-- Depois, recupere UM MES POR VEZ:
--   SELECT public.ponto_materializar_faltas('2026-07-01','2026-07-31','<tenant>');
-- E entao rode 'Reapurar fechadas' na tela de Banco de Horas.
-- ============================================================
